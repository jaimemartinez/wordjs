...
/**
 * Verso block "RestaurantMenu" v2 — full restaurant experience with online ordering.
 *
...
export default function RestaurantMenuVerso({ layout, showImages, showTags, showAllergens, enableOrdering, enableReservations, defaultLang, elementId }) {
