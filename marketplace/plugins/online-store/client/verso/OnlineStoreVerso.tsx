...
/**
 * Verso blocks for the Online Store plugin v2 (multi-block export):
...
export default function OnlineStoreVerso({ category, columns, showSearch, showFilters, showCart, elementId }) {
...
export function StoreOrdersVerso({ title, elementId }) {
...
// Multi-block registration: the registry generator spreads this map into the Verso config.
// The key "OnlineStore" MUST keep its v1 name — existing pages reference it in their Verso document.
export const versoComponents = {
    OnlineStore: { ...onlineStoreDef, render: OnlineStoreVerso },
    StoreOrders: { ...storeOrdersDef, render: StoreOrdersVerso },
};

// Kept for tooling that expects the single-block convention (the generator prefers
// `versoComponents` when it exists).
export const versoComponentDef = onlineStoreDef;
