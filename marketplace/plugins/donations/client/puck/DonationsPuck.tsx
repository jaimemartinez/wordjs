...
/**
 * Puck block "Donations" — donation card for a campaign: image, title, description, animated goal
...
export default function DonationsPuck({ campaignSlug, showGoal, showRecent, accentColor, elementId }) {
