 ...
 *
 * All the logic lives in the Verso block (client/verso/RelatedPostsVerso.tsx): it runs in the
...
exports.init = async function (wordjs) {
    ...
    // Verso block registry. Keeping init a no-op (and permissions empty) means there is nothing to
