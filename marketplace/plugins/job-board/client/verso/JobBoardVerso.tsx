...
/**
 * Verso block "JobBoard" — public job listings with filters, a detail view and an application form.
 *
...
export default function JobBoardVerso({ showFilters, maxJobs, accentColor, elementId }) {
