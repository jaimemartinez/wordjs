...
/**
 * Verso block "Marketplace" — public multi-vendor catalog + inline vendor portal.
 *
...
// ---- Verso definition (NO render key — the registry composes it with the default export) ----------
...
export default function VendorMarketplaceVerso({ mode, category, columns, showFilter, showVendorPortalLink, elementId }) {
