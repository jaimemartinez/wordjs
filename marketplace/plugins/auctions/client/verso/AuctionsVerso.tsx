...
/**
 * Verso block "Auctions" — grid of active auctions (or a single auction by slug) with a live
 * countdown, bid history and a public bid form (honeypot + min-elapsed anti-spam).
 *
 * Registered via manifest.frontend.versoComponents; versoComponentDef must NOT carry a render.
...
export default function AuctionsVerso({ auctionSlug, columns, accentColor, elementId }) {
