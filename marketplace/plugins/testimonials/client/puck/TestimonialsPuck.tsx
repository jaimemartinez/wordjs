...
/**
 * Puck block "Testimonials" — DYNAMIC testimonials pulled from the plugin database (many entries,
...
export default function TestimonialsPuck({ mode, maxItems, showRating, showPhotos, showSubmitForm, elementId }) {
