...
/**
 * Puck block "Breadcrumbs" — renders the navigation trail of the current page:
 ...
 *
 * The block runs in the Puck editor iframe AND on the public page (same puckConfig on both):
...
/** True when running inside the Puck editor canvas iframe (public pages render top-level). */
...
export default function BreadcrumbsPuck({ homeLabel, separator, showJsonLd, showCurrent }) {
    ...
    if (state.mode === "editor") {
        // Representative preview inside the Puck editor, driven by the real props.
        const sample = [
            { label: home, href: "/" },
