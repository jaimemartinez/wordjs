 ...
 *
 * Everything lives in the Verso block (client/verso/BreadcrumbsVerso.tsx), registered via
 * manifest.frontend.versoComponents. The backend side is intentionally empty: no routes,
...
exports.init = async function (wordjs) {
    // Blocks-only plugin: nothing to wire on the backend. The Verso block resolves the
