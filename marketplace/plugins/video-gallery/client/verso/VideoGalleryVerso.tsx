...
interface VideoGalleryVersoProps {
    galleryId?: string;
    title?: string;
    limit?: number;
...
export default function VideoGalleryVerso({ galleryId = "default", title = "Videos", limit = 10, showDescription = false, elementId = "" }: VideoGalleryVersoProps) {
