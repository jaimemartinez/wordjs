...
class MenuItem {
    ...
    // Static methods are attached below the class body (MenuItem.X = ...).
    // Declared here so TypeScript recognizes them on the class.
    static create: (data: any) => Promise<any>;
    static findById: (id: any) => Promise<any>;
    static findByMenu: (menuId: any) => Promise<any[]>;
