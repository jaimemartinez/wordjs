...
const variants = [
  ...
  ['vnode-directory/ipc', '(allow file-read-data (vnode-type DIRECTORY))', true],
  ['vnode-symlink/ipc', '(allow file-read-data (vnode-type SYMLINK))', true],
  ['vnode-character/ipc', '(allow file-read-data (vnode-type CHARACTER-DEVICE))', true],
  ['vnode-block/ipc', '(allow file-read-data (vnode-type BLOCK-DEVICE))', true],
  ['dev-fd/ipc', '(allow file-read-data (literal "/dev/fd"))', true],
  ['root-directory/ipc', '(allow file-read-data (literal "/"))', true],
