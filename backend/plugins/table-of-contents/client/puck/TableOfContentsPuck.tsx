...
/**
 * Puck block "TableOfContents" — automatic page index (Easy Table of Contents /
 * LuckyWP TOC parity).
 *
 * Registered via manifest.frontend.puckComponents; the generated puckPluginRegistry
 * composes { ...puckComponentDef, render: default export }, so puckComponentDef must
...
export default function TableOfContentsPuck({ title, depth, numbered, sticky, puck }) {
