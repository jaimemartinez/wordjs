...
/**
 * Puck block "EventsCalendar" — upcoming-events list OR monthly calendar grid.
 *
...
export default function EventsCalendarPuck({ mode, maxEvents, showDescription, elementId }) {
    return (
