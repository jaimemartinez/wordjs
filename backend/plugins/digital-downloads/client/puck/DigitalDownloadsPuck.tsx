...
/**
 * Puck block "DigitalDownloads" — grid of downloadable products with a token-gated buy/download flow.
 *
...
export default function DigitalDownloadsPuck({ productSlug, columns, elementId }) {
