...
// implementación, dos registros de bloques durante la convivencia con el editor anterior.
    ...
    const ToolbarButton = ({ icon, onClick, title, active = false }: any) => (
        <button
            ...
            onMouseDownCapture={(e) => {
                // Stop the editor from seeing this immediately
                e.stopPropagation();
                handleMouseDown(e);
                onClick(e);
            }}
    ...
    return (
        ...
        >
                ...
                <div className="flex bg-white rounded-lg border border-gray-100 p-0.5 shadow-sm">
                    <div
                        ...
                        onMouseDown={(e) => {
                            ...
                            // but do stop propagation to keep the editor away
                            e.stopPropagation();
                        }}
                    >
            ...
            <div
                ...
                onMouseDownCapture={(e) => {
                    // Block the editor's drag/click while selecting
                    e.stopPropagation();
                }}
...
const baseConfig: any = {
    ...
    components: {
        ...
        Form: {
            ...
            // block's UI lives in blocks/FormBlock.tsx; this entry only registers it.
            label: "Formulario",
            category: "content",
        ...
        Symbol: {
            // Synced reusable block groups ("editas uno, cambian todos") — blocks/SymbolBlock.tsx.
        ...
        render: ({ children }: any) => {
            return (
                <div className="container mx-auto px-4">
                    ...
                    <div className="verso-children w-full">
                        {children}
                    </div>
                </div>
            );
...
export const versoConfig = postConfig;
