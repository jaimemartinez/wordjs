...
import { BLOCK_META, FALLBACK_GROUP, GROUP_ORDER, GROUP_ICON } from "@/lib/blockCatalog";
 ...
 * BLOCK_META (see lib/blockCatalog) adds the icon, the (re)grouping, an optional description, and a
 * label override for plugin blocks that ship without one. Unknown/new blocks fall back to a generic
 * icon in a "Más" group, so nothing is hidden. BLOCK_META + the group constants are shared with the
