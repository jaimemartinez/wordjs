...
export default function RevisionsSidebar({ postId, isOpen, onClose, onRestore }: RevisionsSidebarProps) {
    ...
    return (
        <div className={`fixed inset-y-0 right-0 w-[400px] bg-white shadow-2xl z-[5000] transform transition-transform duration-300 ease-in-out border-l border-gray-100 flex flex-col ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}>
            {/* Header */}
                            ...
                            >
                                ...
                                <div className="flex items-start justify-between gap-4">
                                    ...
                                    <button
                                        ...
                                        className="px-4 py-2 bg-white border border-gray-200 rounded-xl text-[10px] font-black uppercase tracking-widest text-gray-600 hover:border-blue-500 hover:text-blue-600 hover:shadow-md transition-all shrink-0 active:scale-95"
                                    >
                                        Restore
                                    </button>
                                </div>
